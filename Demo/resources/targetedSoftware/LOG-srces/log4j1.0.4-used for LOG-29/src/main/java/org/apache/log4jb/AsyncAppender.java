...
import org.apache.log4jb.helpers.BoundedFIFO;
...
/**
   ...
   <p>Refer to the results in {@link org.apache.log4jb.performance.Logging}
   for the impact of using this appender.

   <p><b>Important note:</b> The <code>AsyncAppender</code> can only
   be script configured using the {@link org.apache.log4jb.xml.DOMConfigurator}.
