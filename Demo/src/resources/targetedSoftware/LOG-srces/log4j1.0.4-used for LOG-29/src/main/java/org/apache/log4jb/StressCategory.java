...
/*
  Stress eu.stamp_project.evocrash the Category class.
...
class StressCategory {
  ...
  public static void main(String[] args) {
    ...
    if(LENGTH >= 7) {
      System.err.println(
        "This stress eu.stamp_project.evocrash suffers from combinatorial explosion.\n"+
  ...
  void test() {    
	...
	System.out.println("Failed stress eu.stamp_project.evocrash.");
	permutationDump();
  ...
  boolean checkCorrectness(int i) {
    ...
    // Can't perform eu.stamp_project.evocrash if category is not instantiated
    if(localCT == null) 
      return true;
