...
import org.apache.log4jb.net.SyslogAppender;
import org.apache.log4jb.performance.NOPWriter;
...
<td>NA
   ...
   org.apache.log4jb.helpers.ISO8601DateFormat} instead of the standard {@link
   java.text.SimpleDateFormat} because of its poor performance. See
   the <b>%d</b> conversion character in {@link
   org.apache.log4jb.PatternLayout}.
   ...
   <p>In a variant of this eu.stamp_project.evocrash, we have inserted a short sleep
...
public class Logging {
  ...
  void  Usage(String msg) {
    ...
    System.err.println(
      "Usage: java org.apache.log4j.eu.stamp_project.evocrash.Logging confFile runLength delay burstLen\n"+
      "        confFile is a configuration file and\n"+
      "        runLength (integer) is the length of eu.stamp_project.evocrash loop.\n"+
      "        delay is the time in millisecs to wait every bustLen log requests.");
    System.exit(1);
  }

  /**
     <b>Usage:</b> <code>java org.apache.log4j.eu.stamp_project.evocrash.Logging confFile runLength [delay] [burstLen]</code>

     <p><code>confFile</code> is an XML configuration file and
      <code>runLength</code> (integer) is the length of eu.stamp_project.evocrash loop,
