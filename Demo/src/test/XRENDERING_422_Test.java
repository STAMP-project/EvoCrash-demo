...
@NotThreadSafe
public class XRENDERING_422_Test extends SystemBase {

    private int frameLevel =3;
    private String ExceptionType = "java.util.NoSuchElementException";
    private String issueNumber = "XRENDERING-422";
    private String softwareVersion = "7.3";
    private Path logPath;
    private String dependencies ="";
    private Path testPath;

    public XRENDERING_422_Test() {
        ...
        logPath = Paths.get(user_dir, "resources", "logs" ,"XWIKI", issueNumber , issueNumber+".log");
